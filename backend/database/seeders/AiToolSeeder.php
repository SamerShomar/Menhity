...
class AiToolSeeder extends Seeder
{
    ...
    {
        /*
         * لا أداة فورية لإنشاء سيرة من الصفر: تلك مقصورة على المسار
         * اليدوي المدفوع الذي يعمل عليه الفريق — إنشاء سيرة كاملة تستحق
         * مراجعة بشرية، لا توليداً فورياً غير مراجَع.
         */
        $tools = [
